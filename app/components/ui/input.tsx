...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "flex w-full min-w-0 rounded-md border border-input bg-transparent px-3 py-1 shadow-xs ",
        ...
        "selection:bg-primary selection:text-primary-foreground dark:bg-input/30 transition-[color,box-shadow] outline-none md:text-sm",
