        ...
        <AccordionContent>
          <div className="space-y-3">
            ...
            <TextField
              ...
              onChange={(value) =>
                withMeta((draft) => {
                  (draft.sections[index].uiSchema as any).loadingMessage =
                    value;
                })
              }
            />
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(event) =>
                  withMeta((draft) => {
                    (draft.sections[index].uiSchema as any).errorMessage =
                      event.target.value;
                  })
                }
              />
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(event) =>
                  withMeta((draft) => {
                    (draft.sections[index].uiSchema as any).successMessage =
                      event.target.value;
                  })
                }
              />
