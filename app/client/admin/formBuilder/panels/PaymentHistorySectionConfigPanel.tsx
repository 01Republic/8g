...
interface PaymentHistorySectionConfigPanelProps {
  sectionId: string;
  sectionIndex: number;
  title?: string;
  uiType: string;
...
const PaymentHistorySectionConfigPanel = ({
  sectionId,
  sectionIndex,
  title,
  uiType,
  ...
  workflows,
  allSections,
}: PaymentHistorySectionConfigPanelProps) => {
...
export default PaymentHistorySectionConfigPanel;
