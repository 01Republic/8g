  ...
  return (
    <form method="POST" className={cn("flex flex-col gap-6", className)} {...props}>
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <h1 className="text-3xl font-bold text-gradient from-[rgb(92,95,238)] to-[rgb(165,166,245)]" >SaaS 관리는 스코디</h1>
      ...
      <div className="grid gap-6">
        <div className="grid gap-3">
          ...
          <Input id="email" name="username" type="email" placeholder="m@example.com" required  className="py-4 pl-13"/>
          </div>
        </div>
        <div className="grid gap-3">
          ...
          <Input id="password" name="password" type="password" required className="py-4 pl-13"/>
