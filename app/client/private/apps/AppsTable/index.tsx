              ...
              <TableRow key={app.id} className="hover:bg-gray-50">
                <TableCell className="font-medium">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">{app.appEnglishName}</div>
                    </div>
                  </div>
                </TableCell>
                ...
                <TableCell>
                  <div className="text-sm">
                    ...
                    <div className="text-gray-500">Used: {app.usedMemberCount.toLocaleString()}</div>
                  </div>
                </TableCell>
                <TableCell>{formatDate(app.nextBillingDate)}</TableCell>
                <TableCell className="font-medium">{formatCurrency(app.nextBillingAmount)}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
